...
<head>
    ...
    <link href="{{ asset('modules/frontend/lib/animate/animate.min.css') }}" rel="stylesheet">
    ...
    {{-- <style>
        .testimonial::after {
            ...
            height: 80px;
            border-radius: 40px;
            background: url('{{ asset('modules/frontend') }}/img/testimonial-img-2.jpg') center center no-repeat;
        ...
        .testimonial::before {
            ...
            height: 80px;
            border-radius: 40px;
            background: url('{{ asset('modules/frontend') }}/img/testimonial-img-3.jpg') center center no-repeat;
    ...
    <div class="container-fluid header position-relative overflow-hidden p-0">
        <nav class="navbar navbar-expand-lg fixed-top navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="index.html" class="navbar-brand p-0">
                <h1 class="display-6 text-primary m-0"><i
                        class="fas fa-envelope me-3"></i>{{ config()->get('app.name', 'Laravel') }}</h1>
        ...
        <div class="hero-header overflow-hidden px-5">
            <div class="rotate-img">
                <img src="{{ asset('modules/frontend') }}/img/sty-1.png" class="img-fluid w-100" alt="">
            ...
            <div class="row gy-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
                    <img src="{{ asset('modules/frontend') }}/img/hero-img-1.png" class="img-fluid w-100 h-100"
                        alt="">
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="RotateMoveLeft">
                        <img src="{{ asset('modules/frontend') }}/img/about-1.png" class="img-fluid w-100"
                            alt="">
                    </div>
                </div>
            ...
            <div class="row g-5 pt-5" style="margin-top: 6rem;">
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                    <div class="feature-img RotateMoveLeft h-100" style="object-fit: cover;">
                        <img src="{{ asset('modules/frontend') }}/img/features-1.png" class="img-fluid w-100 h-100"
                            alt="">
                    </div>
                </div>
        ...
        <div class="container py-5">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="blog-item">
                        <div class="blog-img">
                            <img src="{{ asset('modules/frontend') }}/img/blog-1.png" class="img-fluid w-100"
                                alt="">
                            <div class="blog-info">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="blog-item">
                        <div class="blog-img">
                            <img src="{{ asset('modules/frontend') }}/img/blog-2.png" class="img-fluid w-100"
                                alt="">
                            <div class="blog-info">
                                <span><i class="fa fa-clock"></i> Dec 01.2024</span>
                                <div class="d-flex">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="blog-item">
                        <div class="blog-img">
                            <img src="{{ asset('modules/frontend') }}/img/blog-3.png" class="img-fluid w-100"
                                alt="">
                            <div class="blog-info">
                                <span><i class="fa fa-clock"></i> Dec 01.2024</span>
                                <div class="d-flex">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="blog-item">
                        <div class="blog-img">
                            <img src="{{ asset('modules/frontend') }}/img/blog-4.png" class="img-fluid w-100"
                                alt="">
                            <div class="blog-info">
                                <span><i class="fa fa-clock"></i> Dec 01.2024</span>
                                <div class="d-flex">
        ...
        <div class="container py-5">
            ...
            <div class="testimonial-carousel owl-carousel wow zoomInDown" data-wow-delay="0.2s">
                <div class="testimonial-item"
                    data-dot="<img class='img-fluid' src='{{ asset('modules/frontend') }}/img/testimonial-img-1.jpg' alt=''>">
                    <div class="testimonial-inner text-center p-5">
                        <div class="d-flex align-items-center justify-content-center mb-4">
                            <div class="testimonial-inner-img border border-primary border-3 me-4"
                                ...
                                <img src="{{ asset('modules/frontend') }}/img/testimonial-img-1.jpg"
                ...
                <div class="testimonial-item"
                    data-dot="<img class='img-fluid' src='{{ asset('modules/frontend') }}/img/testimonial-img-2.jpg' alt=''>">
                    <div class="testimonial-inner text-center p-5">
                        <div class="d-flex align-items-center justify-content-center mb-4">
                            <div class="testimonial-inner-img border border-primary border-3 me-4"
                                style="width: 100px; height: 100px; border-radius: 50%;">
                                <img src="{{ asset('modules/frontend') }}/img/testimonial-img-2.jpg"
                                    class="img-fluid rounded-circle" alt="">
                            </div>
                            <div>
                                <h5 class="mb-2">John Abraham</h5>
                ...
                <div class="testimonial-item"
                    data-dot="<img class='img-fluid' src='{{ asset('modules/frontend') }}/img/testimonial-img-3.jpg' alt=''>">
                    <div class="testimonial-inner text-center p-5">
                        <div class="d-flex align-items-center justify-content-center mb-4">
                            <div class="testimonial-inner-img border border-primary border-3 me-4"
                                style="width: 100px; height: 100px; border-radius: 50%;">
                                <img src="{{ asset('modules/frontend') }}/img/testimonial-img-3.jpg"
                                    class="img-fluid rounded-circle" alt="">
                            </div>
                            <div>
                                <h5 class="mb-2">John Abraham</h5>
